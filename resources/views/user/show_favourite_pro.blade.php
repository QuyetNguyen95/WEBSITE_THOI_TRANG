...
<div class="row">
    ...
    <h4>Quản lý sản phẩm yêu thích</h4>
        ...
        <div class="col-md-12 equel-grid">
            <div class="grid">
              <div class="grid-body py-3">
                <p class="card-title ml-n1" style="font-size: 16px;">Sản phẩm yêu thích</p>
              </div>
              <div class="table-responsive">
                ...
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{route('get.delete.favourite.product.user',$product->id)}}" style="margin-left: 20px">
                ...
                <div style="margin-left: 35%; margin-top: 32px;margin-bottom: 50px;">
                    ...
                    <p style="margin-bottom: 20px; margin-left: -129px;">Hãy <i class="mdi mdi-heart" style="color: red;"></i> sản phẩm bạn yêu thích khi mua sắm để xem lại thuận tiện nhất</p>
