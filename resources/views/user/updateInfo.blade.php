              ...
              <div class="row mb-3">
                  <div class="col-md-2">
                    <div class="text-center">
                        ...
                        alt="avatar">
                        @else
                        <img src="{{pare_url_file($user->avatar)}}" class="avatar img-circle img-thumbnail" style="border-radius: 50%; width: 145px; height: 145px;"
                        alt="avatar" >
                        @endif
                ...
                <div class="col-md-9">
                  <div class="form-group row showcase_row_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="inputType1" value="{{$user->name}}" name="name">
                      @if($errors->has('name'))
                  ...
                  <div class="form-group row showcase_row_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="email" class="form-control" id="inputType2" value="{{$user->email}}" name="email">
                      @if($errors->has('email'))
                      <div class="error-text">
                          {{$errors->first('email')}}
                      </div>
                  ...
                  <div class="form-group row showcase_row_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="number" class="form-control" id="inputType4" value="{{$user->phone}}" name="phone">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-3 showcase_text_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <input type="text" class="form-control" id="inputType1" value="{{$user->address}}" name="address">
                    </div>
                  </div>
                  <div class="form-group row showcase_row_area">
                    <div class="col-md-3 showcase_text_area">
                    ...
                    <div class="col-md-9 showcase_content_area">
                      <textarea class="form-control" id="inputType9" cols="12" rows="5" name="note">{{$user->note}}</textarea>
                    </div>
                  </div>
                  <button type="submit" class="btn btn-sm btn-success" style="margin-left: 188px; margin-top: 20px;">Cập nhật</button>
                  <a href="{{route('get.pass.user')}}" style="margin-left: 33px; position: relative;top: 11px;">Bạn muốn thay đổi mật khẩu?</a>
                </div>
              </div>
            </div>
          </div>
